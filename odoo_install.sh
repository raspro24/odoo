...
sudo apt-get install -y software-properties-common wget git build-essential xfonts-75dpi xfonts-base fontconfig libxrender1 node-less libjpeg-dev gdebi postgresql build-essential wget libxslt-dev libzip-dev libldap2-dev libsasl2-dev node-less libjpeg-dev gdebi libpq-dev libxml2-dev libxslt1-dev libldap2-dev libsasl2-dev libffi-dev python3-pypdf2 python3-pil python3-reportlab python3-passlib python3-werkzeug python3-lxml python3-decorator python3-polib python3-psycopg2 python3-dateutil python3-psutil python3-docutils python3-qrcode python3-stdnum python3-zeep python3-pip python3-venv python3-gevent python3-ofxparse python3-ldap
